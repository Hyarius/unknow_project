...
/*   Updated: 2020/02/05 12:55:54 by gboutin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	engine->len[10] = 3;
	if (!(engine->path[10] = (char**)ft_memalloc(sizeof(char*) * 3)))
		error_exit(2, "error ft_memalloc");
	...
	engine->path[11] = NULL;
	engine->len[12] = 1;
	if (!(engine->path[12] = (char**)ft_memalloc(sizeof(char*) * 1)))
		error_exit(2, "error ft_memalloc");
	engine->path[12][0] = ft_strdup("ressources/assets/textures/health.png");
	engine->len[13] = 1;
	if (!(engine->path[13] = (char**)ft_memalloc(sizeof(char*) * 1)))
		error_exit(2, "error ft_memalloc");
	engine->path[13][0] = ft_strdup("ressources/assets/textures/armor.png");
	engine->len[14] = 1;
	if (!(engine->path[14] = (char**)ft_memalloc(sizeof(char*) * 1)))
		error_exit(2, "error ft_memalloc");
...
{
	engine->len[15] = 1;
	if (!(engine->path[15] = (char**)ft_memalloc(sizeof(char*) * 1)))
		error_exit(2, "error ft_memalloc");
	engine->path[15][0] = ft_strdup("ressources/assets/textures/ar.png");
	engine->len[16] = 1;
	if (!(engine->path[16] = (char**)ft_memalloc(sizeof(char*) * 1)))
		error_exit(2, "error ft_memalloc");
	engine->path[16][0] = ft_strdup("ressources/assets/textures/rifle.png");
	engine->len[17] = 1;
	if (!(engine->path[17] = (char**)ft_memalloc(sizeof(char*) * 1)))
		error_exit(2, "error ft_memalloc");
	engine->path[17][0] = ft_strdup("ressources/assets/textures/shotgun.png");
	engine->len[18] = 1;
	if (!(engine->path[18] = (char**)ft_memalloc(sizeof(char*) * 1)))
		error_exit(2, "error ft_memalloc");
...
{
	engine->len[19] = 3;
	if (!(engine->path[19] = (char**)ft_memalloc(sizeof(char*) * 3)))
		error_exit(2, "error ft_memalloc");
	...
	engine->len[20] = 3;
	if (!(engine->path[20] = (char**)ft_memalloc(sizeof(char*) * 3)))
		error_exit(2, "error ft_memalloc");
