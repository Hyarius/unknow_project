...
t_vector2_int_list create_t_vector2_int_list(t_vector2_int src)
{
...
t_vector2_int_list *initialize_t_vector2_int_list(t_vector2_int src)
{
	t_vector2_int_list *list;
	...
	*list = create_t_vector2_int_list(src);
...
void	t_vector2_int_list_push_back(t_vector2_int_list *dest, t_vector2_int to_add)
{
	...
	tmp->next = initialize_t_vector2_int_list(to_add);
}
