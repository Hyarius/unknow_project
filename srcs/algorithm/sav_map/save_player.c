...
void	save_ammo(t_engine *en, int fd, char *st)
{
	...
	st = ft_strjoinf(st, " ", 1);
	st = ft_strjoinf(st, ft_itoa(en->user_engine->player->weapons[0].total_ammo), 3);
	st = ft_strjoinf(st, " ", 1);
	st = ft_strjoinf(st, ft_itoa(en->user_engine->player->weapons[1].ammo), 3);
	st = ft_strjoinf(st, " ", 1);
	st = ft_strjoinf(st, ft_itoa(en->user_engine->player->weapons[1].total_ammo), 3);
	st = ft_strjoinf(st, " ", 1);
	st = ft_strjoinf(st, ft_itoa(en->user_engine->player->weapons[2].ammo), 3);
	st = ft_strjoinf(st, " ", 1);
	st = ft_strjoinf(st, ft_itoa(en->user_engine->player->weapons[2].total_ammo), 3);
	st = ft_strjoinf(st, " ", 1);
	st = ft_strjoinf(st, ft_itoa(en->user_engine->player->weapons[3].ammo), 3);
	st = ft_strjoinf(st, " ", 1);
	st = ft_strjoinf(st, ft_itoa(en->user_engine->player->weapons[3].total_ammo), 3);
	st = ft_strjoinf(st, " ", 1);
	st = ft_strjoinf(st, ft_itoa(en->user_engine->player->weapons[4].ammo), 3);
	st = ft_strjoinf(st, " ", 1);
	st = ft_strjoinf(st, ft_itoa(en->user_engine->player->weapons[4].total_ammo), 3);
	st = ft_strjoinf(st, " ", 1);
	save_card(en, fd, st);
}
