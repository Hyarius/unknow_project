...
{
	t_vector2 new_a = convert_screen_to_opengl(p_win, create_t_vector2(p_a.x, p_a.y));
	t_vector2 new_b = convert_screen_to_opengl(p_win, create_t_vector2(p_b.x, p_b.y));
	t_vector2 new_c = convert_screen_to_opengl(p_win, create_t_vector2(p_c.x, p_c.y));

	set_t_point_vector2(&p_a, new_a);
	set_t_point_vector2(&p_b, new_b);
	set_t_point_vector2(&p_c, new_c);
