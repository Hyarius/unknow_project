...
t_vector3_list create_t_vector3_list(t_vector3 src)
{
	t_vector3_list list;
...
t_vector3_list *initialize_t_vector3_list(t_vector3 src)
{
	t_vector3_list *list;
	...
	*list = create_t_vector3_list(src);
...
void	t_vector3_list_push_back(t_vector3_list *dest, t_vector3 to_add)
{
	...
	tmp->next = initialize_t_vector3_list(to_add);
}
