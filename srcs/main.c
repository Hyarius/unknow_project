...
int main(int argc, char **argv)
{
	...
	// coord[0] = convert_coord_to_opengl(win, create_t_vector3(150, 100, 0));
	// coord[1] = convert_coord_to_opengl(win, create_t_vector3(250, 150, 0));
	// coord[2] = convert_coord_to_opengl(win, create_t_vector3(150, 170, 0));
	// // coord[3] = convert_coord_to_opengl(win, create_t_vector3(250, 300, 0));
	// uv_coord[0] = create_t_vector3(0.0, 0.0, 0.0);
	// uv_coord[1] = create_t_vector3(1.0, 0.0, 0.0);
	// uv_coord[2] = create_t_vector3(0.0, 1.0, 0.0);
	// // uv_coord[3] = create_t_vector3(1.0, 1.0, 0.0);
	...
	// // t_triangle	triangle2 = create_t_triangle(coord[1], coord[2], coord[3]);
	// // t_triangle	uv_triangle2 = create_t_triangle(uv_coord[1], uv_coord[2], uv_coord[3]);
