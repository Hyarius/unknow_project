...
// 	mesh = create_primitive_cube(create_t_vector3(0.0, 0.0, 0.0), create_t_vector3(1.0, 1.0, 1.0), NULL, 100.0, NULL);
// 	t_mesh_rotate(&mesh, create_t_vector3(0.0, 0.0, 0.0));
// 	t_mesh_set_color(&mesh, create_t_color(0.5, 0.6, 0.0 ,1.0));
// 	t_engine_add_mesh(engine, mesh);
...
//  		draw_rectangle_color_cpu(main_camera->view_port, create_t_rectangle(create_t_vector2(0, 0), create_t_vector2(0.003, 0.004)), initialize_t_color(0.0, 0.0, 1.0, 1.0));
