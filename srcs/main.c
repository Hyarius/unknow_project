...
int main(int argc, char **argv)
{
	...
	t_engine_add_mesh(engine, create_primitive_plane(create_t_vector3(0, -1, 0), create_t_vector3(30, 1, 30), NULL, 0.0));
...
// 	t_engine_add_mesh(engine, create_primitive_cube(create_t_vector3(-0.5, -1, -4), create_t_vector3(4, 1, 4), NULL, 0.0));

// 	t_engine_add_mesh(engine, create_primitive_cube(create_t_vector3(-0.5, 3, -4), create_t_vector3(1.5, 1.5, 1.5), NULL, 100.0));
// 	t_engine_add_mesh(engine, create_primitive_cube(create_t_vector3(-0.5, 6, -4), create_t_vector3(3, 3, 3), NULL, 100.0));
// 	t_engine_add_mesh(engine, create_primitive_cube(create_t_vector3(-0.5, 9, -4), create_t_vector3(2.5, 2.5, 2.5), NULL, 100.0));
// 	t_engine_add_mesh(engine, create_primitive_cube(create_t_vector3(-0.5, 12, -4), create_t_vector3(2, 2, 2), NULL, 100.0));
// 	t_engine_add_mesh(engine, create_primitive_cube(create_t_vector3(-0.5, 15, -4), create_t_vector3(1.5, 1.5, 1.5), NULL, 100.0));
// 	t_engine_add_mesh(engine, create_primitive_cube(create_t_vector3(-0.5, 18, -4), create_t_vector3(1, 1, 1), NULL, 100.0));
// 	t_engine_add_mesh(engine, create_primitive_cube(create_t_vector3(-0.5, 21, -4), create_t_vector3(4, 1, 4), NULL, 100.0));
