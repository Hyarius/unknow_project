...
int main(int argc, char **argv)
{
	...
	char *skybox = "ressources/assets/texture/skybox.png";
...
// 	texture2[2] = png_load("ressources/assets/texture/rifle_ammo.png");
// 	texture2[3] = png_load("ressources/assets/texture/shotgun_ammo.png");
// 	char *texture = "ressources/assets/texture/cube_test.png";
// 	char *skybox = "ressources/assets/texture/skybox.png";
...
// 	t_engine_add_mesh(engine, engine->user_engine->player->hitbox);
// 	link_t_camera_to_t_mesh(engine, 0, t_engine_get_mesh(engine, 0), 100);

// 	mesh = create_primitive_plane(create_t_vector4(0.0, 0.0, 0.0), create_t_vector4(10.0, 0.0, 10.0), texture, 0.0);
// 	t_mesh_set_name(&mesh, "plane texture");
// 	t_engine_add_mesh(engine, mesh);
