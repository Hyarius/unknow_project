...
int main(int argc, char **argv)
{
	...
	t_engine_add_mesh(engine, create_primitive_plane(create_t_vector3(0, -1, 0), create_t_vector3(6, 0, 6), NULL, 0.0));
	t_engine_add_mesh(engine, create_primitive_cube(create_t_vector3(0, 20, 0), create_t_vector3(1, 1, 1), NULL, 1.0));
