...
void		print_info_editing(t_camera *main_camera, t_keyboard *key, t_gui *gui)
{
	...
	if (gui->info_print == 1)
	{
		...
		draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(-1.0, 1.0), create_vec2(2.0, -2.0)), gui->menu[12]);
		t_view_port_clear_buffers(main_camera->view_port);
		draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(-1.1, 0.86 - (0.079 * key->i)), create_vec2(0.7, 0.1)), gui->menu[13]);
	}
}
...
void		print_set_player(t_camera *main_camera, t_gui *gui, t_engine *engine)
{
	...
	if (ft_strcmp(player->hitbox.name, "Player") == 0)
	{
		...
		if (player->hitbox.kinetic == 100.0f)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(-0.08, 0.55), create_vec2(0.7, 0.1)), gui->menu[13]);
		else if (player->hitbox.kinetic == 20.0f)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(-0.61, 0.55), create_vec2(0.7, 0.1)), gui->menu[13]);
		if (player->hp == 100)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.0, 0.11), create_vec2(0.4, 0.1)), gui->menu[13]);
		else if (player->hp == 50)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(-0.38, 0.11), create_vec2(0.4, 0.1)), gui->menu[13]);
		if (player->armor == 100)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.125, -0.33), create_vec2(0.4, 0.1)), gui->menu[13]);
		else if (player->armor == 50)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(-0.145, -0.33), create_vec2(0.3, 0.1)), gui->menu[13]);
		else if (player->armor == 0)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(-0.41, -0.33), create_vec2(0.2, 0.1)), gui->menu[13]);
...
void		print_set_weapon(t_camera *main_camera, t_gui *gui, t_engine *engine)
{
	...
	if (ft_strcmp(player->hitbox.name, "Player") == 0)
	{
		...
		if (player->weapons[1].total_ammo == -1)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(-0.023, 0.65), create_vec2(0.18, 0.1)), gui->menu[13]);
		else
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(-0.151, 0.65), create_vec2(0.15, 0.1)), gui->menu[13]);
		if (player->weapons[2].total_ammo == -1)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(-0.023, -0.19), create_vec2(0.18, 0.1)), gui->menu[13]);
		else
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(-0.151, -0.19), create_vec2(0.15, 0.1)), gui->menu[13]);
		if (player->weapons[3].total_ammo == -1)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(-0.023, 0.23), create_vec2(0.18, 0.1)), gui->menu[13]);
		else
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(-0.151, 0.23), create_vec2(0.15, 0.1)), gui->menu[13]);
		if (player->weapons[4].total_ammo == -1)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(-0.023, -0.61), create_vec2(0.18, 0.1)), gui->menu[13]);
		else
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(-0.151, -0.61), create_vec2(0.15, 0.1)), gui->menu[13]);
		if (player->weapons[1].total_ammo == 0 && player->weapons[1].ammo == 0)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.04, 0.52), create_vec2(0.08, 0.1)), gui->menu[13]);
		if (player->weapons[1].total_ammo == 0 && player->weapons[1].ammo == 30)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.1, 0.52), create_vec2(0.08, 0.1)), gui->menu[13]);
		if (player->weapons[1].total_ammo == 30 && player->weapons[1].ammo == 30)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.16, 0.52), create_vec2(0.08, 0.1)), gui->menu[13]);
		if (player->weapons[1].total_ammo == 60 && player->weapons[1].ammo == 30)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.22, 0.52), create_vec2(0.08, 0.1)), gui->menu[13]);
		if (player->weapons[1].total_ammo == 90 && player->weapons[1].ammo == 30)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.285, 0.52), create_vec2(0.08, 0.1)), gui->menu[13]);
		if (player->weapons[1].total_ammo == 120 && player->weapons[1].ammo == 30)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.348, 0.52), create_vec2(0.08, 0.1)), gui->menu[13]);
		if (player->weapons[3].total_ammo == 0 && player->weapons[3].ammo == 0)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.035, 0.095), create_vec2(0.08, 0.1)), gui->menu[13]);
		if (player->weapons[3].total_ammo == 0 && player->weapons[3].ammo == 8)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.095, 0.095), create_vec2(0.08, 0.1)), gui->menu[13]);
		if (player->weapons[3].total_ammo == 8 && player->weapons[3].ammo == 8)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.155, 0.095), create_vec2(0.08, 0.1)), gui->menu[13]);
		if (player->weapons[3].total_ammo == 16 && player->weapons[3].ammo == 8)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.215, 0.095), create_vec2(0.08, 0.1)), gui->menu[13]);
		if (player->weapons[3].total_ammo == 24 && player->weapons[3].ammo == 8)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.28, 0.095), create_vec2(0.08, 0.1)), gui->menu[13]);
		if (player->weapons[3].total_ammo == 32 && player->weapons[3].ammo == 8)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.343, 0.095), create_vec2(0.08, 0.1)), gui->menu[13]);
		if (player->weapons[2].total_ammo == 0 && player->weapons[2].ammo == 0)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.042, -0.33), create_vec2(0.08, 0.1)), gui->menu[13]);
		if (player->weapons[2].total_ammo == 0 && player->weapons[2].ammo == 10)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.105, -0.33), create_vec2(0.08, 0.1)), gui->menu[13]);
		if (player->weapons[2].total_ammo == 10 && player->weapons[2].ammo == 10)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.162, -0.33), create_vec2(0.08, 0.1)), gui->menu[13]);
		if (player->weapons[2].total_ammo == 20 && player->weapons[2].ammo == 10)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.222, -0.33), create_vec2(0.08, 0.1)), gui->menu[13]);
		if (player->weapons[2].total_ammo == 30 && player->weapons[2].ammo == 10)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.287, -0.33), create_vec2(0.08, 0.1)), gui->menu[13]);
		if (player->weapons[2].total_ammo == 40 && player->weapons[2].ammo == 10)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.35, -0.33), create_vec2(0.08, 0.1)), gui->menu[13]);
		if (player->weapons[4].total_ammo == 0 && player->weapons[4].ammo == 0)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.042, -0.755), create_vec2(0.08, 0.1)), gui->menu[13]);
		if (player->weapons[4].total_ammo == 0 && player->weapons[4].ammo == 1)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.105, -0.755), create_vec2(0.08, 0.1)), gui->menu[13]);
		if (player->weapons[4].total_ammo == 1 && player->weapons[4].ammo == 1)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.162, -0.755), create_vec2(0.08, 0.1)), gui->menu[13]);
		if (player->weapons[4].total_ammo == 2 && player->weapons[4].ammo == 1)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.222, -0.755), create_vec2(0.08, 0.1)), gui->menu[13]);
		if (player->weapons[4].total_ammo == 3 && player->weapons[4].ammo == 1)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.287, -0.755), create_vec2(0.08, 0.1)), gui->menu[13]);
		if (player->weapons[4].total_ammo == 4 && player->weapons[4].ammo == 1)
			draw_rectangle_texture_cpu(main_camera->view_port, new_rectangle(create_vec2(0.35, -0.755), create_vec2(0.08, 0.1)), gui->menu[13]);
	}
}
