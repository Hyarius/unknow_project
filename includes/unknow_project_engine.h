...
void			t_engine_place_camera(t_engine *engine, int index, t_vec4 p_new_pos);
void			t_engine_camera_look_at(t_engine *engine, int index, t_vec4 target);
...
void			move_camera(t_camera *camera, t_vec4 mouvement, t_engine *engine, float j);
...
t_mesh_editing	select_mesh(t_keyboard *p_keyboard, t_vec4 pos, char **path);
